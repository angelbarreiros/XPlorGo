...
type XPlorClub struct {
	...
	OpeningDate       *XTime        `json:"openingDate"`       // Nullable, string <date-time>
	...
	CreatedAt         *XTime        `json:"createdAt"`         // Required, string <date-time>
	CreatedBy         string        `json:"createdBy"`         // Required
	DeletedAt         *XTime        `json:"deletedAt"`         // Nullable, string <date-time>
